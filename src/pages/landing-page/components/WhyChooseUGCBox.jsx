...
const WhyChooseUGCBox = ({ visitorType = 'creator' }) => {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            Why Choose <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">UGCBox</span>
          </motion.h2>
          <motion.p
...
export default WhyChooseUGCBox;
